...
FrattalatoreAudioProcessorEditor::FrattalatoreAudioProcessorEditor (FrattalatoreAudioProcessor& p):
    ...
    osc1(audioProcessor.apvts, "OSC1TYPE", "OSC1GAIN", "OSC1PITCH", "OSC1FMFREQ", "OSC1FMDEPTH","osc1"),
    osc2(audioProcessor.apvts, "OSC2TYPE", "OSC2GAIN", "OSC2PITCH", "OSC2FMFREQ", "OSC2FMDEPTH","osc2"),
    osc3(audioProcessor.apvts, "OSC3TYPE", "OSC3GAIN", "OSC3PITCH", "OSC3FMFREQ", "OSC3FMDEPTH","osc3"),
    osc4(audioProcessor.apvts, "OSC4TYPE", "OSC4GAIN", "OSC4PITCH", "OSC4FMFREQ", "OSC4FMDEPTH","osc4"),
    osc5(audioProcessor.apvts, "OSC5TYPE", "OSC5GAIN", "OSC5PITCH", "OSC5FMFREQ", "OSC5FMDEPTH","osc5"),
